...
## Corpus Check
- 558 files · ~258,045 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3042 nodes · 4254 edges · 288 communities (219 shown, 69 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 49 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f0bf93b6`
...
## Communities (288 total, 69 thin omitted)
...
Cohesion: 0.07
Nodes (32): addToCart(), applyPromotions(), deleteLineItem(), getOrSetCart(), initiatePaymentSession(), placeOrder(), setAddresses(), setShippingMethod() (+24 more)
...
Cohesion: 0.14
Nodes (18): CheckoutForm(), retrieveCollection(), getAuthHeaders(), getCacheOptions(), addCustomerAddress(), updateCustomerAddress(), calculatePriceForShippingOption(), listCartShippingMethods() (+10 more)
...
Cohesion: 0.12
Nodes (21): getHubCookie(), readPendingAuth(), listCartOptions(), listFilterCategories(), getHubProductIds(), listHubs(), listLocales(), Login() (+13 more)
...
Cohesion: 0.06
Nodes (14): rolesOf(), ListingModuleService, GET(), EXTRA_LISTING_IDS, KEEP_EMAILS, JUNK_CATEGORY_IDS, PickupSlot, PickupWindow (+6 more)
...
Cohesion: 0.31
Nodes (6): verifySignupTicket(), POST(), hashPin(), verifyPin(), POST(), POST()
...
Cohesion: 0.1
Nodes (27): CategoryPage(), generateMetadata(), generateStaticParams(), Props, getCategoryByHandle(), listCategories(), getCollectionByHandle(), listCollections() (+19 more)
...
Cohesion: 0.13
Nodes (8): hasRole(), LEGACY_ALIASES, Role, STACKABLE_ROLES, StackableRole, downgraded, meta, POST()
...
Cohesion: 0.08
Nodes (22): config, config, config, config, AGING_DAYS, byRider, config, info (+14 more)
...
Cohesion: 0.18
Nodes (16): beforeCutoff(), BuildTiersArgs, DeliveryTier, feeForTier(), HHMM, isMembershipActive(), parseHHMM(), TierOption (+8 more)

### Community 158 - "Community 158"
Cohesion: 0.1
Nodes (20): CodTx, POST(), DispatchModuleService, VALID_DELIVERY_STATUSES, VALID_TRANSITIONS, CodTx, confirmDelivery(), ConfirmDeliveryResult (+12 more)
...
Cohesion: 0.09
Nodes (30): AccountPageLayout(), metadata, Props, Addresses(), metadata, CartButton(), Cart(), metadata (+22 more)
...
Cohesion: 0.18
Nodes (11): GET(), getOrderCashState(), DTC_MODES, listOwedDtc(), OrderItem, OwedRow, ProducerPayout, ProducerPayoutModuleService (+3 more)
...
Cohesion: 0.33
Nodes (7): beforeCutoff(), GET(), nowInHubTimezone(), parseHHMM(), Tier, TierOption, buildDeliveryTiers()
...
Cohesion: 0.25
Nodes (10): POST(), assertSeller(), DELETE(), GET(), loadOwnedProduct(), PATCH(), VALID_STATUSES, validateWindowCreate() (+2 more)
...
Cohesion: 0.14
Nodes (13): author, description, keywords, name, packageManager, private, scripts, analyze (+5 more)
...
## Knowledge Gaps
- **1266 isolated node(s):** `name`, `private`, `packageManager`, `node`, `dev` (+1261 more)
...
- **Why does `retrieveCustomer()` connect `Community 162` to `Account & Checkout Pages`, `Community 135`, `Community 233`, `Community 137`, `Community 173`, `Account Profile Forms`, `Order Transfer Flow`, `Community 190`, `Community 223`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `getAuthHeaders()` connect `Account Profile Forms` to `Community 192`, `Account & Checkout Pages`, `Community 130`, `Community 162`, `Community 36`, `Community 135`, `Community 137`, `Community 233`, `Community 204`, `Community 269`, `Micro Community 50`, `Order Confirmation Flow`, `Order Transfer Flow`, `Community 151`, `Community 223`?**
