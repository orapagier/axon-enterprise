# Graph Report - freshhub  (2026-06-14)

## Corpus Check
- 572 files · ~496,600 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3092 nodes · 4338 edges · 302 communities (231 shown, 71 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57c011de`
...
## Communities (302 total, 71 thin omitted)
...
Cohesion: 0.09
Nodes (24): Cart(), metadata, Checkout(), metadata, addToCart(), applyCustomerAddressToCart(), applyPromotions(), deleteLineItem() (+16 more)
...
Cohesion: 0.12
Nodes (20): CheckoutForm(), retrieveCollection(), getAuthHeaders(), getCacheOptions(), addCustomerAddress(), updateCustomerAddress(), calculatePriceForShippingOption(), listCartShippingMethods() (+12 more)
...
Cohesion: 0.07
Nodes (19): Step, AGING_DAYS, byRider, config, info, ledger, LIMIT_CENTAVOS, logger (+11 more)
...
Cohesion: 0.15
Nodes (5): AccountInfo(), AccountInfoProps, MyInformationProps, MyInformationProps, MyInformationProps
...
Cohesion: 0.08
Nodes (49): setHubCookie(), syncCustomerHubFromCookie(), GOOGLE_ERROR_COPY, Props, ROLE_COPY, exchangeCodeForClaims(), GoogleAuthPending, GoogleIdTokenClaims (+41 more)
...
Cohesion: 0.05
Nodes (55): AccountTypesPage(), requestMembership(), backendFetch(), getRiderManifest(), getRiderSession(), getRiderSummary(), markStopDelivered(), markStopRefused() (+47 more)
...
Cohesion: 0.27
Nodes (6): config, config, config, JobInput, runJob(), unwrap()

### Community 151 - "Community 151"
Cohesion: 0.08
Nodes (29): ChatTurn, runAssistant(), AssistantConfigError, assistantEnabled(), DEFAULT_MODELS, detectProvider(), getProvider(), ProviderId (+21 more)
...
Cohesion: 0.13
Nodes (23): beforeCutoff(), GET(), nowInHubTimezone(), parseHHMM(), Tier, TierOption, beforeCutoff(), buildDeliveryTiers() (+15 more)
...
Cohesion: 0.11
Nodes (21): AccountPageLayout(), Addresses(), metadata, cancelMembership(), cancelMembershipRenewal(), retrieveCustomer(), updateCustomer(), getReferralPanel() (+13 more)
...
Cohesion: 0.17
Nodes (10): CartButton(), ProductActionsWrapper(), ProductTemplate(), ProductTemplateProps, isMember(), getTraderPricing(), INACTIVE, isApprovedTrader() (+2 more)
...
Cohesion: 0.23
Nodes (11): getCustomerId(), POST(), REASON_MESSAGE, REASON_STATUS, AppealEligibility, AppealEligibilityInput, canAppeal(), evaluateAppealEligibility() (+3 more)
...
Cohesion: 0.1
Nodes (14): PREPAY_LOCKED_STATES, AccountabilityModuleService, GET(), getCustomerId(), accountability, BuyerAccountStatus, RefusalDispute, InjectedDeps (+6 more)
...
Cohesion: 0.06
Nodes (38): baseHeaders(), listOpenPickupWindows(), PickupWindow, baseHeaders(), createListing(), deleteListing(), getMyListing(), ListingFormState (+30 more)
...
Cohesion: 0.09
Nodes (19): POST(), isDuplicateCodTransaction(), CodLedgerModuleService, POST(), GET(), getCustomerId(), getCustomerId(), POST() (+11 more)
...
Cohesion: 0.23
Nodes (12): assertSeller(), DELETE(), GET(), loadOwnedProduct(), PATCH(), ProductVariantWithPrices, StoreCustomer, VALID_STATUSES (+4 more)

### Community 269 - "Community 269"
Cohesion: 0.23
Nodes (8): AddressBookProps, AddAddress(), EditAddress(), EditAddressProps, hubSlugForCity(), deleteCustomerAddress(), useToggleState(), SideMenu()

### Community 271 - "Community 271"
Cohesion: 0.16
Nodes (16): VALID_DECISIONS, config, dispatchBatchesInTransit(), notifyBatchInTransit(), parseHHmm(), config, disputeSlaTick(), sendEmail() (+8 more)
...
Cohesion: 0.24
Nodes (10): listFilterCategories(), getHubProductIds(), CategoryTemplate(), CollectionTemplate(), StoreTemplate(), getDeliveryHub(), HUB_CITIES, HUB_CITY_VARIANTS (+2 more)

### Community 282 - "Community 282"
Cohesion: 0.19
Nodes (12): useIntersection(), ProductActions(), ProductActionsProps, ProductPreview(), PreviewPrice(), ProductPrice(), ProductQuickAdd(), QuickAddProps (+4 more)
...
Cohesion: 0.28
Nodes (6): completeOnboarding(), deferOnboarding(), isValidPhone(), OnboardingState, resetOnboardingState(), splitDisplayName()
...
## Knowledge Gaps
- **1280 isolated node(s):** `name`, `private`, `packageManager`, `node`, `dev` (+1275 more)
...
- **Why does `GET()` connect `Community 135` to `Community 162`, `Auth Login/Register`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `retrieveCustomer()` connect `Community 162` to `Account & Checkout Pages`, `Community 292`, `Community 135`, `Community 233`, `Community 137`, `Community 173`, `Account Profile Forms`, `Order Transfer Flow`, `Community 280`, `Community 282`, `Community 285`, `Community 223`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `getAuthHeaders()` connect `Account Profile Forms` to `Community 192`, `Account & Checkout Pages`, `Community 130`, `Community 162`, `Community 292`, `Community 36`, `Community 135`, `Community 137`, `Community 233`, `Community 204`, `Community 269`, `Micro Community 50`, `Order Confirmation Flow`, `Order Transfer Flow`, `Community 151`, `Community 223`?**
