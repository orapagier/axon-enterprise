...
## Corpus Check
- 441 files · ~190,040 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2418 nodes · 3013 edges · 265 communities (204 shown, 61 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dab58352`
...
## Communities (265 total, 61 thin omitted)
...
Cohesion: 0.17
Nodes (15): CategoryPage(), generateMetadata(), generateStaticParams(), Props, getCategoryByHandle(), listCategories(), retrieveCollection(), getCacheOptions() (+7 more)
...
Cohesion: 0.2
Nodes (11): CheckoutForm(), getAuthHeaders(), calculatePriceForShippingOption(), listCartShippingMethods(), createTransferRequest(), getPaymentEligibility(), listCartPaymentMethods(), PaymentEligibility (+3 more)
...
Cohesion: 0.13
Nodes (15): AccountPageLayout(), CartButton(), Cart(), metadata, metadata, OverviewTemplate(), retrieveCustomer(), metadata (+7 more)
...
Cohesion: 0.06
Nodes (20): POST(), isDuplicateCodTransaction(), CodLedgerModuleService, POST(), CodTx, POST(), GET(), getCustomerId() (+12 more)
...
Cohesion: 0.13
Nodes (7): DispatchModuleService, config, dispatchBatchesInTransit(), parseHHmm(), config, DispatchBatch, DispatchOrder
...
Cohesion: 0.09
Nodes (9): AccordionItemProps, AccordionProps, ProductTabsProps, categories, origins, RefinementListProps, SortOptions, SortProductsProps (+1 more)
...
Cohesion: 0.13
Nodes (18): getCacheTag(), baseHeaders(), createListing(), deleteListing(), ListingFormState, parseListing(), SellerListing, updateListing() (+10 more)
...
Cohesion: 0.19
Nodes (10): getHubProductIds(), CategoryTemplate(), CollectionTemplate(), ProductTemplate(), ProductTemplateProps, StoreTemplate(), getDeliveryHub(), HUB_CITIES (+2 more)
...
Cohesion: 0.28
Nodes (6): getLocale(), setLocaleCookie(), updateLocale(), newHeaders, originalFetch, getLocaleHeader()
...
- **Why does `retrieveCustomer()` connect `Product Quick Add` to `Account & Checkout Pages`, `Community 130`, `Community 135`, `Community 136`, `Community 137`, `Community 264`, `Community 269`, `Account Profile Forms`, `Community 242`, `Community 147`, `Community 182`, `Auth Login/Register`, `Community 250`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `getAuthHeaders()` connect `Auth Login/Register` to `Account & Checkout Pages`, `Community 130`, `Community 36`, `Product Quick Add`, `Community 135`, `Community 264`, `Community 268`, `Account Profile Forms`, `Community 179`, `Community 275`, `Order Confirmation Flow`, `Community 223`?**
