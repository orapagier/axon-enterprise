...
## Corpus Check
- 485 files · ~210,896 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2582 nodes · 3347 edges · 281 communities (218 shown, 63 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `45f58af4`
...
## Communities (281 total, 63 thin omitted)
...
Cohesion: 0.13
Nodes (20): Checkout(), metadata, addToCart(), applyCustomerAddressToCart(), applyPromotions(), deleteLineItem(), getOrSetCart(), listCartOptions() (+12 more)
...
Cohesion: 0.13
Nodes (20): CheckoutForm(), initiatePaymentSession(), setShippingMethod(), retrieveCollection(), getAuthHeaders(), getCacheOptions(), calculatePriceForShippingOption(), listCartShippingMethods() (+12 more)
...
Cohesion: 0.15
Nodes (9): VALID_STATUSES, AGING_DAYS, config, LIMIT_CENTAVOS, Rider, hashPin(), RiderModuleService, POST() (+1 more)
...
Cohesion: 0.12
Nodes (17): listProducts(), listProductsWithSort(), getRegion(), regionMap, retrieveRegion(), SearchHit, searchProducts(), generateMetadata() (+9 more)
...
Cohesion: 0.14
Nodes (14): CodTx, POST(), DispatchModuleService, VALID_DELIVERY_STATUSES, config, CodTx, confirmDelivery(), ConfirmDeliveryResult (+6 more)
...
Cohesion: 0.11
Nodes (21): baseHeaders(), createListing(), deleteListing(), getMyListing(), ListingFormState, parseListing(), SellerListing, updateListing() (+13 more)
...
Cohesion: 0.31
Nodes (7): getCollectionByHandle(), listCollections(), CollectionPage(), generateStaticParams(), Props, Home(), metadata
...
## Knowledge Gaps
- **1106 isolated node(s):** `name`, `private`, `packageManager`, `node`, `dev` (+1101 more)
...
- **Why does `GET()` connect `Community 182` to `Community 166`, `Product Quick Add`, `Community 278`, `Community 246`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `retrieveCustomer()` connect `Product Quick Add` to `Account & Checkout Pages`, `Community 135`, `Community 136`, `Community 137`, `Community 206`, `Account Profile Forms`, `Community 147`, `Community 182`, `Community 246`, `Community 251`, `Community 223`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `getCacheTag()` connect `Community 246` to `Account & Checkout Pages`, `Community 135`, `Account Profile Forms`, `Community 182`, `Community 223`?**
