...
## Corpus Check
- 557 files · ~257,913 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3036 nodes · 4248 edges · 293 communities (224 shown, 69 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 49 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `abb6a7bc`
...
Cohesion: 0.01
Nodes (197): AccountHolder, Address, ApiKey, ApiKeyTypeEnum, ApplicationMethod, ApplicationMethodAllocationEnum, ApplicationMethodTargetTypeEnum, ApplicationMethodTypeEnum (+189 more)

### Community 1 - "Account & Checkout Pages"
Cohesion: 0.12
Nodes (29): addToCart(), applyPromotions(), deleteLineItem(), getOrSetCart(), initiatePaymentSession(), placeOrder(), setAddresses(), setShippingMethod() (+21 more)

### Community 2 - "Price & Order Utils"
Cohesion: 0.11
Nodes (15): CartDropdown(), CartTotals(), CartTotalsProps, FreeShippingInline(), FreeShippingPopup(), ShippingDetails(), ShippingDetailsProps, TIER_LABELS (+7 more)
...
Cohesion: 0.19
Nodes (10): MembershipUpsellStrip(), Props, MobileActions(), MobileActionsProps, OptionSelectProps, ProductPrice(), getProductPrice(), getMemberPrice() (+2 more)
...
Cohesion: 0.1
Nodes (21): CategoryPage(), generateMetadata(), generateStaticParams(), Props, CheckoutForm(), CodWalletStatus, Wallet, getCategoryByHandle() (+13 more)
...
Cohesion: 0.23
Nodes (12): upload, authenticateRider(), b64url(), getSecret(), PUBLIC_RIDER_PATHS, RiderTokenPayload, sign(), signRiderToken() (+4 more)
...
Cohesion: 0.12
Nodes (5): ListingModuleService, EXTRA_LISTING_IDS, KEEP_EMAILS, ProductListing, ModuleImplementations
...
Cohesion: 0.11
Nodes (13): metadata, TransferPage(), metadata, OverviewTemplate(), acceptTransferRequest(), createTransferRequest(), declineTransferRequest(), listOrders() (+5 more)

### Community 37 - "Product Quick Add"
Cohesion: 0.14
Nodes (10): VALID_STATUSES, verifySignupTicket(), POST(), GET(), Rider, hashPin(), verifyPin(), RiderModuleService (+2 more)
...
Cohesion: 0.05
Nodes (52): setHubCookie(), syncCustomerHubFromCookie(), GOOGLE_ERROR_COPY, Props, ROLE_COPY, exchangeCodeForClaims(), GoogleAuthPending, GoogleIdTokenClaims (+44 more)
...
Cohesion: 0.05
Nodes (57): AccountTypesPage(), cancelMembership(), cancelMembershipRenewal(), requestMembership(), backendFetch(), getRiderManifest(), getRiderSession(), getRiderSummary() (+49 more)
...
Cohesion: 0.12
Nodes (15): config, config, config, AGING_DAYS, byRider, config, info, ledger (+7 more)
...
Cohesion: 0.11
Nodes (23): AccountPageLayout(), CartButton(), Cart(), metadata, Checkout(), metadata, applyCustomerAddressToCart(), retrieveCart() (+15 more)
...
Cohesion: 0.16
Nodes (11): metadata, Props, AccountLayoutProps, hasRole(), LEGACY_ALIASES, Role, ROLE_ICONS, ROLE_LABELS (+3 more)
...
Cohesion: 0.24
Nodes (10): GET(), getCustomerId(), disputeSlaTick(), AppealEligibility, AppealEligibilityInput, canAppeal(), evaluateAppealEligibility(), toMs() (+2 more)
...
Cohesion: 0.07
Nodes (20): PREPAY_LOCKED_STATES, AccountabilityModuleService, Step, accountability, JUNK_CATEGORY_IDS, purgeDevData(), BuyerAccountStatus, RefusalDispute (+12 more)
...
Cohesion: 0.16
Nodes (16): baseHeaders(), listOpenPickupWindows(), PickupWindow, baseHeaders(), createListing(), deleteListing(), ListingFormState, parseListing() (+8 more)
...
Cohesion: 0.33
Nodes (6): updateCustomer(), addProducerRole(), addTraderRole(), FieldCollector, makeCollector(), MyInformationProps
...
Cohesion: 0.15
Nodes (11): AddressBookProps, AddAddress(), EditAddress(), EditAddressProps, hubSlugForCity(), addCustomerAddress(), deleteCustomerAddress(), updateCustomerAddress() (+3 more)
...
Cohesion: 0.12
Nodes (14): useIntersection(), Item(), ItemProps, LineItemUnitPrice(), LineItemUnitPriceProps, ProductActions(), ProductActionsProps, ProductPreview() (+6 more)
...
## Knowledge Gaps
- **1263 isolated node(s):** `name`, `private`, `packageManager`, `node`, `dev` (+1258 more)
...
- **Why does `GET()` connect `Community 135` to `Account & Checkout Pages`, `Community 162`, `Community 278`, `Auth Login/Register`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `retrieveCustomer()` connect `Community 162` to `Account & Checkout Pages`, `Community 130`, `Community 36`, `Community 135`, `Community 137`, `Community 201`, `Community 173`, `Account Profile Forms`, `Order Transfer Flow`, `Community 183`, `Community 250`, `Community 283`, `Community 190`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `getAuthHeaders()` connect `Account & Checkout Pages` to `Community 130`, `Community 162`, `Community 36`, `Community 135`, `Community 137`, `Community 204`, `Community 269`, `Account Profile Forms`, `Micro Community 50`, `Order Confirmation Flow`, `Order Transfer Flow`, `Community 151`, `Community 250`, `Community 223`?**
