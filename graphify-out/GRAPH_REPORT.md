...
## Summary
- 3109 nodes · 4386 edges · 288 communities (221 shown, 67 thin omitted)
...
## Communities (288 total, 67 thin omitted)
...
Cohesion: 0.1
Nodes (18): POST(), Action, appendEvent(), MEMBERSHIP_META, MembershipEvent, GrantOutcome, grantReferralReward(), promoSuffix() (+10 more)
...
Cohesion: 0.13
Nodes (11): DispatchModuleService, recordRefusal(), getRiderId(), GET(), GET(), DispatchBatch, DispatchOrder, POST() (+3 more)
...
Cohesion: 0.07
Nodes (34): AccountPageLayout(), Cart(), metadata, Checkout(), metadata, applyCustomerAddressToCart(), retrieveCart(), cancelMembership() (+26 more)
...
Cohesion: 0.1
Nodes (26): getCacheTag(), removeAuthToken(), deleteAccount(), DeleteAccountState, signout(), baseHeaders(), listOpenPickupWindows(), PickupWindow (+18 more)
...
Cohesion: 0.21
Nodes (9): AccountInfo(), AddressBookProps, AddAddress(), EditAddress(), EditAddressProps, hubSlugForCity(), deleteCustomerAddress(), useToggleState() (+1 more)
...
Cohesion: 0.05
Nodes (28): GREETING, Msg, SUGGESTIONS, MENU_LINKS, MenuLink, PRODUCER_LINK, RIDER_LINK, ACCOUNT_TYPES_NAV_ITEM (+20 more)
...
## Knowledge Gaps
- **1285 isolated node(s):** `name`, `private`, `packageManager`, `node`, `dev` (+1280 more)
