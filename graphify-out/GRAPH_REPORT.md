...
## Corpus Check
- 585 files · ~506,944 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3167 nodes · 4497 edges · 308 communities (236 shown, 72 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 51 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fc19f9bc`
...
Cohesion: 0.09
Nodes (27): CartButton(), Cart(), metadata, Checkout(), metadata, sanitizeCity(), addToCart(), applyCustomerAddressToCart() (+19 more)

### Community 2 - "Price & Order Utils"
Cohesion: 0.15
Nodes (10): CartDropdown(), CartTotals(), CartTotalsProps, TIER_LABELS, FreeShippingInline(), FreeShippingPopup(), ShippingDetails(), ShippingDetailsProps (+2 more)
...
Cohesion: 0.14
Nodes (19): CheckoutForm(), retrieveCollection(), getAuthHeaders(), getCacheOptions(), calculatePriceForShippingOption(), listCartShippingMethods(), createTransferRequest(), getPaymentEligibility() (+11 more)
...
Cohesion: 0.14
Nodes (17): getHubCookie(), listCartOptions(), listFilterCategories(), getHubProductIds(), listHubs(), listLocales(), metadata, PageLayout() (+9 more)

### Community 23 - "Auth Login/Register"
Cohesion: 0.12
Nodes (21): upload, exchangeCodeForClaims(), GoogleIdTokenClaims, readCookie(), RiderGoogleAuthPending, authenticateRider(), b64url(), getSecret() (+13 more)
...
Cohesion: 0.12
Nodes (9): GET(), POST(), UpsertRow, validateRow(), GET(), DeliveryFeesModuleService, FeeRow, TAGUM_FEES (+1 more)

### Community 26 - "Root Layout & Fonts"
Cohesion: 0.09
Nodes (8): VALID_DELIVERY_STATUSES, ListingModuleService, EXTRA_LISTING_IDS, KEEP_EMAILS, ProductListing, Rider, RiderModuleService, ModuleImplementations

### Community 27 - "Account Navigation"
Cohesion: 0.24
Nodes (16): clearPendingAuth(), cancelPendingAuth(), clearPendingAuth(), deriveCustomerSecret(), generateCode(), generateDerivedPassword(), hashCode(), OtpThrottle (+8 more)
...
Cohesion: 0.11
Nodes (23): Addresses(), metadata, getCollectionByHandle(), listCollections(), listProducts(), listProductsWithSort(), getRegion(), listRegions() (+15 more)
...
Cohesion: 0.18
Nodes (16): syncCustomerHubFromCookie(), exchangeCodeForClaims(), GoogleAuthPending, GoogleIdTokenClaims, generateCode(), hashCode(), OtpThrottle, PendingAuth (+8 more)
...
Cohesion: 0.05
Nodes (58): AccountPageLayout(), isAwaitingVerification(), AccountTypesPage(), cancelMembership(), cancelMembershipRenewal(), backendFetch(), getRiderManifest(), getRiderSession() (+50 more)
...
Cohesion: 0.11
Nodes (36): beforeCutoff(), GET(), nowInHubTimezone(), parseHHMM(), Tier, TierOption, accountability, assertWithinDeliveryHours() (+28 more)

### Community 158 - "Community 158"
Cohesion: 0.12
Nodes (19): POST(), isDuplicateCodTransaction(), POST(), CodTx, POST(), DispatchModuleService, CodTx, confirmDelivery() (+11 more)
...
Cohesion: 0.08
Nodes (32): metadata, Props, requestMembership(), retrieveCustomer(), updateCustomer(), getReferralPanel(), addProducerRole(), addTraderRole() (+24 more)

### Community 164 - "Community 164"
Cohesion: 0.15
Nodes (16): getCustomerId(), POST(), REASON_MESSAGE, REASON_STATUS, expirePickupWindows(), AdminMessage, chatIds(), ensureConfigured() (+8 more)
...
Cohesion: 0.29
Nodes (8): ProductActionsWrapper(), PreviewPrice(), isMember(), getTraderPricing(), INACTIVE, isApprovedTrader(), TRADER_META, TraderPricing
...
Cohesion: 0.24
Nodes (8): canonicalHubCity(), provinceForCity(), completeOnboarding(), deferOnboarding(), isValidPhone(), OnboardingState, resetOnboardingState(), splitDisplayName()
...
Cohesion: 0.14
Nodes (15): useIntersection(), LineItemUnitPrice(), LineItemUnitPriceProps, ProductActions(), ProductActionsProps, ProductPreview(), Props, ProductPrice() (+7 more)
...
Cohesion: 0.05
Nodes (29): GREETING, Msg, SUGGESTIONS, MENU_LINKS, MenuLink, PRODUCER_LINK, RIDER_LINK, ACCOUNT_TYPES_NAV_ITEM (+21 more)
...
Cohesion: 0.11
Nodes (23): disputeSlaTick(), AppealEligibility, AppealEligibilityInput, canAppeal(), evaluateAppealEligibility(), toMs(), verifyPhaseG(), escalated (+15 more)

### Community 199 - "Community 199"
Cohesion: 0.07
Nodes (25): POST(), PickupSlot, PickupWindow, PickupModuleService, PICKUP_SLOT_STATUSES, PICKUP_WINDOW_STATUSES, PickupSlotStatus, PickupWindowStatus (+17 more)
...
Cohesion: 0.09
Nodes (16): PREPAY_LOCKED_STATES, AccountabilityModuleService, Step, GET(), getCustomerId(), JUNK_CATEGORY_IDS, purgeDevData(), BuyerAccountStatus (+8 more)
...
Cohesion: 0.18
Nodes (7): GOOGLE_ERROR_COPY, Props, ROLE_COPY, AccountType, AuthMode, OtpRequestState, OtpVerifyState
...
Cohesion: 0.1
Nodes (26): placeOrder(), getCacheTag(), removeAuthToken(), removeCartId(), deleteAccount(), signout(), baseHeaders(), listOpenPickupWindows() (+18 more)
...
Cohesion: 0.17
Nodes (18): assertSeller(), DELETE(), GET(), loadOwnedProduct(), PATCH(), ProductVariantWithPrices, StoreCustomer, VALID_STATUSES (+10 more)
...
Cohesion: 0.25
Nodes (8): haversineKm(), HUB_CITY_SET, HUB_SLUG_BY_CITY, HUB_WAREHOUSE, HubCity, isHubCity(), PROVINCE_BY_CITY, toRad()
...
Cohesion: 0.1
Nodes (14): CodLedgerModuleService, GET(), getCustomerId(), getCustomerId(), POST(), CodTx, recordOtcCollected(), RecordOtcResult (+6 more)
...
Cohesion: 0.22
Nodes (8): CategoryPage(), generateMetadata(), generateStaticParams(), Props, CodWalletStatus, Wallet, getCategoryByHandle(), listCategories()

### Community 286 - "Community 286"
Cohesion: 0.53
Nodes (4): cityMatchesHub(), Hub, HubResolution, normalizeCity()
...
Cohesion: 0.14
Nodes (10): AddressBookProps, AddAddress(), EditAddress(), EditAddressProps, Props, hubSlugForCity(), addCustomerAddress(), deleteCustomerAddress() (+2 more)
...
Cohesion: 0.27
Nodes (7): config, config, config, config, JobInput, runJob(), unwrap()
...
Cohesion: 0.13
Nodes (9): SearchHit, searchProducts(), ImageGallery(), ImageGalleryProps, SellerListingForm(), ImageOrPlaceholder(), ThumbnailProps, BACKEND_ORIGINS (+1 more)
...
- **Why does `GET()` connect `Community 135` to `Community 162`, `Community 304`, `Auth Login/Register`, `Account Navigation`, `Micro Community 62`, `Community 223`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `retrieveCustomer()` connect `Community 162` to `Account & Checkout Pages`, `Community 130`, `Community 135`, `Community 137`, `Community 173`, `Account Profile Forms`, `Order Transfer Flow`, `Community 183`, `Community 280`, `Community 282`, `Account Navigation`, `Community 223`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `getAuthHeaders()` connect `Account Profile Forms` to `Community 288`, `Account & Checkout Pages`, `Community 130`, `Community 162`, `Community 36`, `Community 135`, `Community 137`, `Community 204`, `Micro Community 50`, `Order Confirmation Flow`, `Order Transfer Flow`, `Community 151`, `Community 183`, `Community 282`, `Account Navigation`, `Micro Community 62`, `Community 223`?**
