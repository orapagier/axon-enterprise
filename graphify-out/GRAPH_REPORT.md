...
## Corpus Check
- 573 files · ~496,798 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3094 nodes · 4339 edges · 289 communities (222 shown, 67 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `63980677`
...
## Communities (289 total, 67 thin omitted)
...
Cohesion: 0.12
Nodes (19): addToCart(), applyPromotions(), deleteLineItem(), getOrSetCart(), initiatePaymentSession(), placeOrder(), setShippingMethod(), submitPromotionForm() (+11 more)
...
Cohesion: 0.1
Nodes (22): CheckoutForm(), CodWalletStatus, Wallet, retrieveCollection(), getAuthHeaders(), getCacheOptions(), calculatePriceForShippingOption(), listCartShippingMethods() (+14 more)
...
Cohesion: 0.15
Nodes (8): DispatchModuleService, VALID_DELIVERY_STATUSES, VALID_TRANSITIONS, recordRefusal(), DispatchBatch, DispatchOrder, POST(), POST()
...
Cohesion: 0.07
Nodes (33): AccountPageLayout(), metadata, Props, Addresses(), metadata, retrieveCustomer(), completeOnboarding(), deferOnboarding() (+25 more)

### Community 164 - "Community 164"
Cohesion: 0.13
Nodes (10): VALID_STATUSES, verifySignupTicket(), POST(), JUNK_CATEGORY_IDS, Rider, hashPin(), verifyPin(), RiderModuleService (+2 more)
...
Cohesion: 0.33
Nodes (7): PreviewPrice(), getTraderPrice(), getTraderPricing(), INACTIVE, isApprovedTrader(), TRADER_META, TraderPricing
...
Cohesion: 0.16
Nodes (11): AccountTypesPanel(), manilaDate(), Props, cancelMembership(), cancelMembershipRenewal(), updateCustomer(), addProducerRole(), AddRoleState (+3 more)
...
Cohesion: 0.23
Nodes (9): CartButton(), Cart(), metadata, Checkout(), metadata, applyCustomerAddressToCart(), retrieveCart(), ProductActionsWrapper() (+1 more)
...
Cohesion: 0.08
Nodes (28): getCacheTag(), baseHeaders(), listOpenPickupWindows(), PickupWindow, baseHeaders(), createListing(), deleteListing(), ListingFormState (+20 more)
...
Cohesion: 0.21
Nodes (16): assertSeller(), DELETE(), GET(), loadOwnedProduct(), PATCH(), ProductVariantWithPrices, StoreCustomer, getStockLocationId() (+8 more)
...
Cohesion: 0.06
Nodes (25): GREETING, Msg, SUGGESTIONS, MENU_LINKS, MenuLink, PRODUCER_LINK, RIDER_LINK, ACCOUNT_TYPES_NAV_ITEM (+17 more)
...
- **Why does `GET()` connect `Community 135` to `Community 162`, `Auth Login/Register`, `Community 223`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `retrieveCustomer()` connect `Community 162` to `Account & Checkout Pages`, `Community 135`, `Community 233`, `Community 137`, `Community 173`, `Account Profile Forms`, `Order Transfer Flow`, `Community 183`, `Community 280`, `Community 190`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `getAuthHeaders()` connect `Account Profile Forms` to `Account & Checkout Pages`, `Community 130`, `Community 162`, `Community 36`, `Community 135`, `Community 137`, `Community 233`, `Community 204`, `Community 269`, `Micro Community 50`, `Order Confirmation Flow`, `Order Transfer Flow`, `Community 151`, `Community 183`, `Community 190`, `Community 223`?**
