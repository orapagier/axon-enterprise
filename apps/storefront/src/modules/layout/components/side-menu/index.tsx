                    ...
                    <div className="flex items-center justify-between px-6 py-5 border-b border-grey-10/80">
                      <div className="flex items-center gap-x-2.5">
                        ...
                        <svg width="32" height="32" viewBox="0 0 96 96" fill="none">
                          <path d="M48 10 L81 29 L81 67 L48 86 L15 67 L15 29 Z" fill="url(#mobile-logo-gradient)" />
                          ...
                          <defs>
                            <linearGradient id="mobile-logo-gradient" x1="0" y1="0" x2="96" y2="96" gradientUnits="userSpaceOnUse">
