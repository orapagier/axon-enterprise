      ...
      >
        ...
        <nav className="content-container flex items-center justify-between w-full h-full">
          ...
          <div className="flex items-center h-full">
            ...
            <span className="hidden medium:inline-flex items-center gap-x-1.5 px-3 py-1.5 mr-3 rounded-full bg-white border border-grey-10 text-[10px] font-semibold text-grey-70 uppercase tracking-[0.12em] shadow-soft">
